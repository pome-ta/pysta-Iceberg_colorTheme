#[Pythonista/theme/theme_forum.py at master · tdamdouni/Pythonista · GitHub](https://github.com/tdamdouni/Pythonista/blob/master/theme/theme_forum.py)
...
_themes = [
  'Dawn', 'Tomorrow', 'Solarized Light', 'Solarized Dark', 'Cool Glow', 'Gold',
  'Tomorrow Night', 'Oceanic', 'Editorial'
]

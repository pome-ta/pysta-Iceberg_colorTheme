...
def url_scheme_to_bytes_json(full_url_scheme: str) -> bytes:
  # theme-dataを取得
...
def url_scheme_to_str_json(full_url_scheme: str) -> str:
  decompressed_data = url_scheme_to_bytes_json(full_url_scheme)
...
scheme_str_json = url_scheme_to_str_json(url_scheme)
scheme_bytes_json = url_scheme_to_bytes_json(url_scheme)
...
#print(scheme_bytes_json == local_bytes_json)
res = difflib.diff_bytes(difflib.context_diff, scheme_bytes_json,
                         local_bytes_json)
#print('\n'.join(res))

#print(str(res))

#print(scheme_str_json == local_str_json)

res = difflib.unified_diff(scheme_str_json, local_str_json)
print('\n'.join(res))

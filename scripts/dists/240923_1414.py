...
class VSCodeThemeObject:
  ...
  def __init__(self,
    ...
    self.local_path = Path(ROOT_PATH, './vscodeThemes') if local is None else Path(local) if isinstance(local,
                                                                                                        str) else local
  ...
  def export(self, vs_themes: str | Path | None = None):
    vs_themes = self.local_path if vs_themes is None else Path(vs_themes) if isinstance(vs_themes, str) else vs_themes
  ...
  def export(self,
    ...
    if save_local:
      ...
      self.local_path = Path(ROOT_PATH,
                             './testThemes') if local_dir is None else Path(local_dir) if isinstance(local_dir,
                                                                                                     str) else local_dir
